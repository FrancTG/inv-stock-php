<aside>
    <div class="logged-account">
        ...
        <a class="logout" href="/inv-stock-php/src/logout.php">Logout</a>
    </div>
    <div class="cart-info">
    ...
    <nav>
        <ul>
            ...
            <li><a href="/inv-stock-php/src/purchases/purchases-list.php"><ion-icon name="basket"></ion-icon>Purchases</a></li>
            ...
            <?php if ($_SESSION["rol"] == "admin") echo "<li><a href='/inv-stock-php/src/users/users-list.php'><ion-icon name='people'></ion-icon>Users</a></li>"; ?>
        </ul>
    </nav>
    <div></div>
    <script>
        ...
        function viewOrder() {
            location.href = "/inv-stock-php/src/cart.php?cart="+localStorage.getItem("orderProducts")
        }
    </script>
</aside>